...
void cordiccart2pol(data_t x, data_t y, data_t * r,  data_t * theta)
{
    ...
    // data_t current_x = x;
    // data_t current_y = y;
    current_theta += sigma * angles[0] * 2; // sigma * 90 degrees
