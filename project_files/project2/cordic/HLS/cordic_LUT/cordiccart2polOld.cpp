...
{
#ifdef SYNTHESIS
	static data_t my_LUT_th[LUT_SIZE] = {0}; //  use static so it doesn't update everytime 
    static data_t my_LUT_r[LUT_SIZE] = {0};  
    ...
    init_cart2pol_LUTs(my_LUT_th, my_LUT_r); // put real values in LUT
#endif
