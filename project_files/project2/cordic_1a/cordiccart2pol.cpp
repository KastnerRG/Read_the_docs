...
void cordiccart2pol(data_t x, data_t y, data_t * r,  data_t * theta)
{
    ...
    *r = current_x * 0.6072529350088812561694;  // Final magnitude * (K=lim_n->inf K(n))
